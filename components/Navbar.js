...
const Navbar = ({cart, subtotal , addToCart , removeToCart , clearCart}) => {
 ...
 <div className="flex flex-col md:flex-row md:justify-start justify-center items-center my-1 shadow-md">
    ...
    <div ref={ref} className="sidecart w-[100%] sm:w-[40%] h-full overflow-y-scroll bg-pink-50 absolute right-0 top-0 px-8 py-10 transform transition-transform translate-x-full z-10">
      ...
      <button onClick={clearCart} className="flex mx-2 mt-16 text-white bg-pink-500 border-0 py-2 px-2 focus:outline-none hover:bg-pink-400 rounded text-sm"><></>Clear Cart</button>
