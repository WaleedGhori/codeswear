    ...
    <section className="text-gray-600 body-font overflow-hidden">
      ...
      <div className="container px-5 py-16 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" className="lg:w-1/2 w-full h-full px-24 md:px-32 object-cover object-top rounded" src={product.img} />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div className="flex">
                ...
                {Object.keys(variant).includes('black') && Object.keys(variant['black']).includes(size) && <button onClick={() => { refrehvariant(size, 'black') }} className={`border-2 ${color === 'sky blue' ? 'border-black' : 'border-gray-300'} ml-1 bg-black rounded-full w-6 h-6 focus:outline-none`}></button>}
              </div>
            ...
            <div className="flex ">
              <span className="title-font font-medium text-2xl ml-[-1rem] text-gray-900">Rs 999</span>
              <button onClick={() => { buyNow(slug, 1, product.price, product.title, product.size, product.color) }} className="flex md:ml-2  ml-2 sm:ml-8 text-white bg-pink-500 border-0 py-2 px-2 sm:px-4 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
              <button onClick={() => { addToCart(slug, 1, product.price, product.title, product.size, product.color) }} className="flex ml-2 md:ml-4 text-white bg-pink-500 border-0 py-2 px-2 sm:px-4md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
            ...
            <div className="pin flex mt-6 space-x-2 text-sm">
              <input onChange={onchangePin} className='border-gray-200 px-2 border-2 rounded-md' placeholder='Enter a pincode' type="text" />
              <button onClick={checkservice} className='mx-2  text-white bg-pink-500 border-0 py-2 px-2 focus:outline-none hover:bg-pink-400 rounded text-sm'>Check</button>
            </div>
