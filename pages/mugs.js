...
const Mugs = ({products}) => {
  ...
  <section className="text-gray-600 body-font">
    <div className="container px-5 py-24 mx-auto">
     ...
     {Object.keys(products).length ===0 && <p className="font-bold">Sorry all the mugs are currently out of stock, New stock will be comming soon....</p>}
     ...
     return <Link passHref={true} key={products[item]._id} href={`/products/${products[item].slug}`}>
      <div className="  lg:w-1/5 md:w-1/2 p-4 w-full shadow-md m-4 cursor-pointer ">
        <a className="block relative h-48 rounded overflow-hidden">
          <img alt="ecommerce" className="m-auto h-[32vh] md:h-[36vh] block" src={products[item].img}/>{/* md:mx-0*/}
        </a>
        <div className="mt-4 text-center md:text-left">
          ...
          {products[item].color.includes('sky blue') && <button className="border-2 border-gray-300 ml-1 bg-sky-400 rounded-full w-6 h-6 focus:outline-none"></button> }
...
export default Mugs;
//https://images-na.ssl-images-amazon.com/images/I/81bP6068bBL.__AC_SX300_SY300_QL70_FMwebp_.jpg